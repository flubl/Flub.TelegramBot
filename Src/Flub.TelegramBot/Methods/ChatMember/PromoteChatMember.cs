...
namespace Flub.TelegramBot.Methods
{
    ...
    /// Pass <see langword="false"/> for all boolean parameters to demote a user.
    ...
    public class PromoteChatMember : Method<bool?>
    {
        ...
        /// <summary>
        /// Pass <see langword="true"/>, if the administrator can access the chat event log, chat statistics, message statistics in channels,
        ...
        /// <summary>
        /// Pass <see langword="true"/>, if the administrator can edit messages of other users and can pin messages, channels only.
        /// </summary>
        ...
        /// <summary>
        /// Pass <see langword="true"/>, if the administrator can add new administrators with a subset of their own privileges or demote administrators that he has promoted,
    ...
    public static class PromoteChatMemberExtension
    {
        ...
        /// <param name="canEditMessages">Pass <see langword="true"/>, if the administrator can edit messages of other users and can pin messages, channels only.</param>
        /// <param name="canDeleteMessages">Pass <see langword="true"/>, if the administrator can delete messages of other users.</param>
        /// <param name="canManageVoiceChats">Pass <see langword="true"/>, if the administrator can manage voice chats.</param>
